...
namespace Lab2
{
    class Article: IRateAndCopy
    {
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hash = 24;
                hash = (hash * 97) + (!Object.ReferenceEquals(null, Title) ? Title.GetHashCode() : 0);
                hash = (hash * 97) + (!Object.ReferenceEquals(null, Rating) ? Rating.GetHashCode() : 0);
                hash = (hash * 97) + (!Object.ReferenceEquals(null, Author) ? Author.GetHashCode() : 0);
                return hash;
            }
        }
